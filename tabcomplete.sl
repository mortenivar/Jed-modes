...
% The delimiter for expanding newlines in help and apropos messages
...
private define spell_popup_menu()
{
  ...
  menu_append_item($1, "&Show Help for Word at Point", "show_hlp_for_word_at_point");
  menu_append_item($1, "&Apropos", "compl_apropos");
...
define compl_apropos ()
{
  ...
  most_mode ();
  bob ();
  flush("Type <enter> on a red keyword to read its help message. Type 'q' to quit");
}
