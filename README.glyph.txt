...
ideograms like emoticons and the like that cannot be typed from a keyboard.
...
Jed and the Foot and Kitty terminals under Wayland. Under Xorg, not much
...
"/usr/share/unicode/NamesList.txt". If it is in some other place, then edit
